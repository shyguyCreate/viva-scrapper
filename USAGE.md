...
| ---------- | --------------------------------------- |
| cmd.exe    | _<venv\>_\Scripts\activate.bat          |
| PowerShell | _<venv\>_\Scripts\Activate.ps1          |
...
| ---------- | --------------------------------------- |
| bash/zsh   | **source** _<venv\>_/bin/activate       |
...
_Para saber las direcciones de PATH ejecutar el commando:_
